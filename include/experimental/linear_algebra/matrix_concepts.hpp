...
{
  { m.columns() }         noexcept -> ::std::same_as< typename M::size_type >;
  { m.rows() }            noexcept -> ::std::same_as< typename M::size_type >;
  { m.column_capacity() } noexcept -> ::std::same_as< typename M::size_type >;
  { m.row_capacity() }    noexcept -> ::std::same_as< typename M::size_type >;
};
...
requires( const M& m, typename M::index_type index1, typename M::index_type index2 ) // C)
{
  ...
  { m[index1,index2] }       noexcept -> ::std::same_as<typename M::value_type>;
  #endif
  #if LINALG_USE_PAREN_OPERATOR
  { m(index1,index2) }       noexcept -> ::std::same_as<typename M::value_type>;
  #endif
  { m.at(index1,index2) }             -> ::std::same_as<typename M::value_type>;
} &&
( M::span_type::extents_type::rank() == 2 ) &&                                       // D)
requires( const M& m, typename M::index_type index )                                 // E)
{
  typename M::const_row_type;
  { m.row(index) }                    -> ::std::same_as<typename M::const_row_type>;
} &&
...
requires( const M& m, typename M::index_type index )                                 // F)
{
  ...
  { m.column(index) }                 -> ::std::same_as<typename M::const_column_type>;
} &&
...
requires( M& m, typename M::index_type index1, typename M::index_type index2 ) // C)
{
  ...
  #if LINALG_USE_BRACKET_OPERATOR
  { m[index1,index2] }       noexcept -> ::std::same_as<typename M::reference>;
  #endif
  #if LINALG_USE_PAREN_OPERATOR
  { m(index1,index2) }       noexcept -> ::std::same_as<typename M::reference>;
  #endif
  { m.at(index1,index2) }             -> ::std::same_as<typename M::reference>;
} &&
requires( M& m, typename M::index_type index )                                 // D)
{
  typename M::row_type;
  { m.row(index) }                    -> ::std::same_as<typename M::row_type>;
} &&
writable_vector_data<typename M::row_type> &&
requires( M& m, typename M::index_type index )                                 // E)
{
  typename M::column_type;
  { m.column(index) }                 -> ::std::same_as<typename M::column_type>;
} &&
...
detail::is_constexpr( []{ decltype( ::std::declval<M>().rows() )            nodiscard_warning = M().rows(); } ) &&
detail::is_constexpr( []{ decltype( ::std::declval<M>().columns() )         nodiscard_warning = M().columns(); } ) &&
detail::is_constexpr( []{ decltype( ::std::declval<M>().row_capacity() )    nodiscard_warning = M().row_capacity(); } ) &&
detail::is_constexpr( []{ decltype( ::std::declval<M>().column_capacity() ) nodiscard_warning = M().column_capacity(); } ) &&
...
( ::std::is_convertible_v< typename From::value_type, typename To::value_type > ) &&
...
template < class T, class = void > struct has_const_row_type : public ::std::false_type { };
template < class T > struct has_const_row_type< T, ::std::enable_if_t< ::std::is_same_v< typename T::const_row_type, typename T::const_row_type > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_const_column_type : public ::std::false_type { };
...
template < class T, class = void > struct has_rows_func : public ::std::false_type { };
template < class T > struct has_rows_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().rows() ), typename T::size_type > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_rows_func_v = has_rows_func<T>::value;

// Test for columns function
template < class T, class = void > struct has_columns_func : public ::std::false_type { };
template < class T > struct has_columns_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().columns() ), typename T::size_type > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_columns_func_v = has_columns_func<T>::value;

// Test for row_capacity function
template < class T, class = void > struct has_row_capacity_func : public ::std::false_type { };
template < class T > struct has_row_capacity_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().row_capacity() ), typename T::size_type > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_column_capacity_func : public ::std::false_type { };
template < class T > struct has_column_capacity_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().column_capacity() ), typename T::size_type > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_const_index_paren_oper_two : public ::std::false_type { };
template < class T > struct has_const_index_paren_oper_two< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().operator()( ::std::declval<typename T::index_type>(), ::std::declval<typename T::index_type>() ) ), typename T::value_type > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_const_index_bracket_oper_two : public ::std::false_type { };
template < class T > struct has_const_index_bracket_oper_two< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().operator[]( ::std::declval<typename T::index_type>(), ::std::declval<typename T::index_type>() ) ), typename T::value_type > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_const_index_bracket_oper_two_v = has_const_index_bracket_oper_two<T>::value;

// Test for index paren operator
template < class T, class = void > struct has_index_paren_oper_two : public ::std::false_type { };
template < class T > struct has_index_paren_oper_two< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<T>().operator()( ::std::declval<typename T::index_type>(), ::std::declval<typename T::index_type>() ) ), typename T::reference > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_index_paren_oper_two_v = has_index_paren_oper_two<T>::value;

// Test for index bracket operator
template < class T, class = void > struct has_index_bracket_oper_two : public ::std::false_type { };
template < class T > struct has_index_bracket_oper_two< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<T>().operator[]( ::std::declval<typename T::index_type>(), ::std::declval<typename T::index_type>() ) ), typename T::reference > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_const_row_func : public ::std::false_type { };
template < class T > struct has_const_row_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().row( ::std::declval<typename T::index_type>() ) ), typename T::const_row_type > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_const_row_func_v = has_const_row_func<T>::value;

// Test for row function
template < class T, class = void > struct has_row_func : public ::std::false_type { };
template < class T > struct has_row_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().row( ::std::declval<typename T::index_type>() ) ), typename T::row_type > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_row_func_v = has_row_func<T>::value;

// Test for const column function
template < class T, class = void > struct has_const_column_func : public ::std::false_type { };
template < class T > struct has_const_column_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().column( ::std::declval<typename T::index_type>() ) ), typename T::const_column_type > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_const_column_func_v = has_const_column_func<T>::value;

// Test for column function
template < class T, class = void > struct has_column_func : public ::std::false_type { };
template < class T > struct has_column_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().column( ::std::declval<typename T::index_type>() ) ), typename T::column_type > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_column_func_v = has_column_func<T>::value;

// Test for const submatrix function
template < class T, class = void > struct has_const_submatrix_func : public ::std::false_type { };
template < class T > struct has_const_submatrix_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().submatrix( ::std::declval<typename T::tuple_type>(), ::std::declval<typename T::tuple_type>() ) ), typename T::const_submatrix_type > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_submatrix_func : public ::std::false_type { };
template < class T > struct has_submatrix_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().submatrix( ::std::declval<typename T::tuple_type>(), ::std::declval<typename T::tuple_type>() ) ), typename T::submatrix_type > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_submatrix_func_v = has_submatrix_func<T>::value;

// Test for matrix multiplication
template < class T, class = void > struct has_matrix_multi_func : public ::std::false_type { };
template < class T > struct has_matrix_multi_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<T>() * trans( ::std::declval<T>() ) ), decltype( ::std::declval<T>() * trans( ::std::declval<T>() ) ) > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_readable_row_vector_type : public ::std::false_type { };
template < class T > struct has_readable_row_vector_type< T, ::std::enable_if_t< readable_vector_data_v< typename T::const_row_vector_type > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_readable_column_vector_type : public ::std::false_type { };
template < class T > struct has_readable_column_vector_type< T, ::std::enable_if_t< readable_vector_data_v< typename T::const_column_vector_type > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_writable_row_vector_type : public ::std::false_type { };
template < class T > struct has_writable_row_vector_type< T, ::std::enable_if_t< writable_vector_data_v< typename T::row_vector_type > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_writable_column_vector_type : public ::std::false_type { };
template < class T > struct has_writable_column_vector_type< T, ::std::enable_if_t< writable_vector_data_v< typename T::column_vector_type > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_writable_column_vector_type_v = has_writable_column_vector_type<T>::value;

//- Test for matrices

// Matrix data
template < class M > struct matrix_data : public ::std::conditional_t< 
  tensor_data_v<M> &&
  is_rank_v<M,2> &&
  has_rows_func_v<M> &&
  has_columns_func_v<M> &&
  has_row_capacity_func_v<M> &&
  has_column_capacity_func_v<M>, ::std::true_type, ::std::false_type > { };
template < class M > inline constexpr bool matrix_data_v = matrix_data<M>::value;

// Matrix
template < class M > struct matrix : public ::std::conditional_t< 
  matrix_data_v<M> &&
  tensor_v<M> &&
  has_trans_func_v<M> &&
  has_conj_func_v<M> &&
  has_matrix_multi_func_v<M>, ::std::true_type, ::std::false_type > { };
template < class M > inline constexpr bool matrix_v = matrix<M>::value;

// Readable matrix data
template < class M > struct readable_matrix_data : public ::std::conditional_t< 
  matrix_data_v<M> &&
...
// Readable matrix
template < class M > struct readable_matrix : public ::std::conditional_t< 
  readable_matrix_data_v<M> &&
  matrix_v<M>, ::std::true_type, ::std::false_type > { };
template < class M > inline constexpr bool readable_matrix_v = readable_matrix<M>::value;

// Writable matrix data
template < class M > struct writable_matrix_data : public ::std::conditional_t< 
  matrix_data_v<M> &&
...
// Writable matrix
template < class M > struct writable_matrix : public ::std::conditional_t< 
  writable_matrix_data_v<M> &&
  matrix_v<M>, ::std::true_type, ::std::false_type > { };
template < class M > inline constexpr bool writable_matrix_v = writable_matrix<M>::value;

// Dynamic matrix data
template < class M > struct dynamic_matrix_data : public ::std::conditional_t< 
  matrix_data_v<M> &&
  dynamic_tensor_data_v<M>, ::std::true_type, ::std::false_type > { };
template < class M > inline constexpr bool dynamic_matrix_data_v = dynamic_matrix_data<M>::value;

// Dynamic matrix
template < class M > struct dynamic_matrix : public ::std::conditional_t< 
...
template < class M > struct fixed_size_matrix_data : public ::std::conditional_t< 
  matrix_data_v<M> &&
  fixed_size_tensor_data_v<M>
#if LINALG_HAS_CXX_20
  && detail::is_constexpr( []{ [[maybe_unused]] decltype( ::std::declval<M>().rows() )            nodiscard_warning = M().rows(); } ) &&
  detail::is_constexpr( []{ [[maybe_unused]] decltype( ::std::declval<M>().columns() )         nodiscard_warning = M().columns(); } ) &&
  detail::is_constexpr( []{ [[maybe_unused]] decltype( ::std::declval<M>().row_capacity() )    nodiscard_warning = M().row_capacity(); } ) &&
  detail::is_constexpr( []{ [[maybe_unused]] decltype( ::std::declval<M>().column_capacity() ) nodiscard_warning = M().column_capacity(); } ) &&
  ( M().rows()    == M().row_capacity() ) &&
  ( M().columns() == M().column_capacity() )
#endif
...
// Fixed size matrix
template < class M > struct fixed_size_matrix : public ::std::conditional_t< 
