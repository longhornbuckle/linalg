...
requires( const V& v, typename V::index_type index ) // C)
{
  ...
  { v[index] }       noexcept -> ::std::same_as<typename V::value_type>;
  #endif
  #if LINALG_USE_PAREN_OPERATOR
  { v(index) }       noexcept -> ::std::same_as<typename V::value_type>;
  #endif
  { v.at(index) }             -> ::std::same_as<typename V::value_type>;
} &&
          ...
          typename V::index_type end )               // E)
{
  ...
  { v.subvector(start,end) } -> ::std::same_as<typename V::const_subvector_type>;
...
requires( V& v, typename V::index_type index )            // C)
{
  ...
  #if LINALG_USE_BRACKET_OPERATOR
  { v[index] }       noexcept -> ::std::same_as<typename V::reference>;
  #endif
  #if LINALG_USE_PAREN_OPERATOR
  { v(index) }       noexcept -> ::std::same_as<typename V::reference>;
  #endif
  { v.at(index) }             -> ::std::same_as<typename V::reference>;
} &&
requires( V&                     v,
          typename V::index_type start,
          typename V::index_type end )                    // D)
{
  ...
  { v.subvector(start,end) } -> ::std::same_as<typename V::subvector_type>;
  { v.subvector(start,end) } -> vector_data;
};
...
template < class T, class = void > struct has_const_subvector_type : public ::std::false_type { };
template < class T > struct has_const_subvector_type< T, ::std::enable_if_t< ::std::is_same_v< typename T::const_subvector_type, typename T::const_subvector_type > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_subvector_type : public ::std::false_type { };
template < class T > struct has_subvector_type< T, ::std::enable_if_t< ::std::is_same_v< typename T::subvector_type, typename T::subvector_type > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_subvector_type_v = has_subvector_type<T>::value;

//- Test for functions

// Test for inner product
template < class T, class = void > struct has_inner_prod_func : public ::std::false_type { };
template < class T > struct has_inner_prod_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( inner_prod( ::std::declval<T>(), ::std::declval<T>() ) ), decltype( inner_prod( ::std::declval<T>(), ::std::declval<T>() ) ) > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_inner_prod_func_v = has_inner_prod_func<T>::value;

// Test for outer product
template < class T, class = void > struct has_outer_prod_func : public ::std::false_type { };
template < class T > struct has_outer_prod_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( outer_prod( ::std::declval<T>(), ::std::declval<T>() ) ), decltype( outer_prod( ::std::declval<T>(), ::std::declval<T>() ) ) > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_outer_prod_func_v = has_outer_prod_func<T>::value;

// Test for index paren operator
template < class T, class = void > struct has_const_index_paren_oper_one : public ::std::false_type { };
template < class T > struct has_const_index_paren_oper_one< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().operator()( ::std::declval<typename T::index_type>() ) ), typename T::value_type > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_const_index_bracket_oper_one : public ::std::false_type { };
template < class T > struct has_const_index_bracket_oper_one< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().operator[]( ::std::declval<typename T::index_type>() ) ), typename T::value_type > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_const_index_bracket_oper_one_v = has_const_index_bracket_oper_one<T>::value;

// Test for index paren operator
template < class T, class = void > struct has_index_paren_oper_one : public ::std::false_type { };
template < class T > struct has_index_paren_oper_one< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<T>().operator()( ::std::declval<typename T::index_type>() ) ), typename T::reference > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_index_paren_oper_one_v = has_index_paren_oper_one<T>::value;

// Test for index bracket operator
template < class T, class = void > struct has_index_bracket_oper_one : public ::std::false_type { };
template < class T > struct has_index_bracket_oper_one< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<T>().operator[]( ::std::declval<typename T::index_type>() ) ), typename T::reference > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_const_subvector_func : public ::std::false_type { };
template < class T > struct has_const_subvector_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().subvector( ::std::declval<typename T::index_type>(), ::std::declval<typename T::index_type>() ) ), decltype( ::std::declval<const T>().subvector( ::std::declval<typename T::index_type>(), ::std::declval<typename T::index_type>() ) ) > > > : public ::std::true_type { };
...
template < class T, class = void > struct has_subvector_func : public ::std::false_type { };
template < class T > struct has_subvector_func< T, ::std::enable_if_t< ::std::is_same_v< decltype( ::std::declval<const T>().subvector( ::std::declval<typename T::index_type>(), ::std::declval<typename T::index_type>() ) ), decltype( ::std::declval<const T>().subvector( ::std::declval<typename T::index_type>(), ::std::declval<typename T::index_type>() ) ) > > > : public ::std::true_type { };
template < class T > inline constexpr bool has_subvector_func_v = has_subvector_func<T>::value;

//- Test for vectors

// Vector data
template < class V > struct vector_data : public ::std::conditional_t< 
  tensor_data_v<V> &&
  is_rank_v<V,1>, ::std::true_type, ::std::false_type > { };
template < class V > inline constexpr bool vector_data_v = vector_data<V>::value;

// Vector
template < class V > struct vector : public ::std::conditional_t< 
  vector_data_v<V> &&
  tensor_v<V> &&
  has_trans_func_v<V> &&
  has_conj_func_v<V> &&
  has_inner_prod_func_v<V> &&
  has_outer_prod_func_v<V>, ::std::true_type, ::std::false_type > { };
template < class V > inline constexpr bool vector_v = vector<V>::value;

// Readable vector data
template < class V > struct readable_vector_data : public ::std::conditional_t< 
  vector_data_v<V> &&
  ...
  has_const_subvector_func_v<V>, ::std::true_type, ::std::false_type > { };
template < class V > inline constexpr bool readable_vector_data_v = readable_vector_data<V>::value;

// Readable vector
template < class V > struct readable_vector : public ::std::conditional_t< 
  readable_vector_data_v<V> &&
  vector_v<V>, ::std::true_type, ::std::false_type > { };
template < class V > inline constexpr bool readable_vector_v = readable_vector<V>::value;

// Writable vector data
template < class V > struct writable_vector_data : public ::std::conditional_t< 
  readable_vector_data_v<V> &&
  ...
  has_subvector_func_v<V>, ::std::true_type, ::std::false_type > { };
template < class V > inline constexpr bool writable_vector_data_v = writable_vector_data<V>::value;

// Writable vector
template < class V > struct writable_vector : public ::std::conditional_t< 
  writable_vector_data_v<V> &&
  vector_v<V>, ::std::true_type, ::std::false_type > { };
template < class V > inline constexpr bool writable_vector_v = writable_vector<V>::value;

// Dynamic vector data
template < class V > struct dynamic_vector_data : public ::std::conditional_t< 
  vector_data_v<V> &&
  dynamic_tensor_data_v<V>, ::std::true_type, ::std::false_type > { };
template < class V > inline constexpr bool dynamic_vector_data_v = dynamic_vector_data<V>::value;

// Dynamic vector
template < class V > struct dynamic_vector : public ::std::conditional_t< 
...
template < class V > struct fixed_size_vector_data : public ::std::conditional_t< 
  vector_data_v<V> &&
  fixed_size_tensor_data_v<V>, ::std::true_type, ::std::false_type > { };
template < class V > inline constexpr bool fixed_size_vector_data_v = fixed_size_vector_data<V>::value;

// Fixed size vector
template < class V > struct fixed_size_vector : public ::std::conditional_t< 
